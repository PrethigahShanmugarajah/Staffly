...
export const inngest = new Inngest({ id: "Staffly" });
    ...
    if (!attendance?.checkOut) {
      ...
      await sendEmail({
        ...
        <div style='max-width: 600px;'>
          ...
          <p style='font-size: 16px;'>Staffly</p>
        </div>`,
      });
...
const attendanceReminderCron = inngest.createFunction(
  {
    ...
    triggers: [{ cron: "TZ=Asia/Colombo 45 17 * * *" }],
  },
  async ({ step }) => {
        ...
        const emailPromises = absentEmployees.map((emp) => {
          ...
          return sendEmail({
            ...
            <div style='max-width: 600px; font-family: Arial, sans-serif;'>
              ...
              <p style='font-size: 14px; color: #666666'>Department: ${emp.department}</p>

              <br />

              <p style='font-size: 16px;'>Best Regards,</p>

              <p style='font-size: 16px;'><strong>Staffly</strong></p>
            </div>`,
          });
        });
